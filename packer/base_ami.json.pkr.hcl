...
# file can be moved to other files.For example,
the variable blocks could be
# moved to their own 'variables.pkr.hcl' file,
etc.Those files need to be
...
# https : //www.packer.io/docs/templates/hcl_templates/variables#type-constraints for more info.
    ...
    # "timestamp" template function replacement locals {
    ...
    source "amazon-ebs" "autogenerated_1" {
        ...
        tags = {
            Author = "user" Environment = "dev" Tool = "Packer"
        }
        vpc_id = "${var.vpc_id}"
    }
